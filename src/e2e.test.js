...
describe("App.js", () => {
    ...
    it("e2e : X win", async () => {
        ...
        await page.click(".tactic_00");
        await page.click(".tactic_01");
        await page.click(".tactic_11");
        await page.click(".tactic_12");
        await page.click(".tactic_22");
    ...
    it("e2e : 0 win", async () => {
        ...
        await page.click(".tactic_00");
        await page.click(".tactic_01");
        await page.click(".tactic_10");
        await page.click(".tactic_11");
        await page.click(".tactic_22");
        await page.click(".tactic_21");
        const text = await page.$eval(".result", (e) => e.textContent);
    ...
    it("e2e : No one win", async () => {
      ...
      await page.click(".tactic_00");
      await page.click(".tactic_01");
      await page.click(".tactic_02");
      await page.click(".tactic_12");
      await page.click(".tactic_11");
      await page.click(".tactic_20");
      await page.click(".tactic_10");
      await page.click(".tactic_22");
      await page.click(".tactic_21");
      const text = await page.$eval(".result", (e) => e.textContent);
